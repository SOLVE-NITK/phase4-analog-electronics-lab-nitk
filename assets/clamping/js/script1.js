...
graph.addEventListener('click', function(){
    ...
    let exp1;
    let exp2;
        // let exp1 = "a*(Math.sin(x))";
        // let exp2 = "a*(Math.sin(x)) + c";
        // let exp3= "a*(Math.sign(Math.sin(x))";
        // let exp4= "a*(Math.sign(Math.sin(x))+c";
        // let exp5 = "a*(Math.asin(Math.sin(x))";
        // let exp6 = "a*(Math.asin(Math.sin(x))+c"
   switch(d){
    case "1":
        exp1= "a*(Math.sin(x))";
        exp2="a*(Math.sin(x))+c";
...
//     var a = document.getElementById("Ipv").value.trim();
//     // var b = document.getElementById("freq").value.trim();
//     var b = document.getElementById("bias").value.trim();
//     var c = parseFloat(document.getElementById("Ipv").value)+ parseFloat(document.getElementById("bias").value);
//     if(a!=="" && b!==""){
//         let exp1 = "a*(Math.sin(x))";
//         let exp2 = "a* Math.sin(x) + c";
//   const xValues = [];
...
//   Plotly.newPlot("graphscreen1",data,layout);
// }
// else{
